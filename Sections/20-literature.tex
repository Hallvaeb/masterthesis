...
\paragraph{Percieved value to museum stakeholders}
...
% todo under ethichal considerations burde jeg skrive noe om etisk ansvar man har som utvikler og det å forstå hva gdpr er før man utvilker noe som bryter med det. ansvar for utvikling. Stille krav til etisk morals kompass, selv om ikke alltid dette blir gjort i andre yrker alltid? Jo ofte, veterinærer som velger å ikke avlive unge kjæledyr som familier bare er gått lei av å passe for eksempel.
...
% \begin{wrapfigure}{r}{0.5\textwidth}
    %     \vspace{-15pt}
    %     \centering
    %     \includegraphics[width=0.5\textwidth]{Images/Ethical/redmon-twutter-stoppedCV.png}
